...
@app.get("/manage/games/{game_id}/scoring", response_class=HTMLResponse)
...
@app.post("/manage/games/{game_id}/matches/{match_id}/score")
...
@app.post("/manage/games/{game_id}/matches/{match_id}/player-stat")
